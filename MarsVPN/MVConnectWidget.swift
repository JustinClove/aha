...
class MVConnectWidget: UIView {
    ...
    private func stateDidChanged() {
        ...
        case .connect:
            ...
            stopAnimation()
            connectedTipsLabel.text = "Tap to connect"
...
//        shadowView1.isUserInteractionEnabled = false
    ...
    func update(_ model: NodeModel) {
        self.imageView.kf.setImage(with: URL(string: model.imagePath()), placeholder: model.flagImage() ?? UIImage(named: "country_flag"))
